...
object RecyclingSymbolContent {
    ...
    init {
        ...
        ITEMS.add(RecyclingSymbol(
            ...
            "**참고 출처 수정** -> 링크(링크 적을 시 링크 제목 \n\n 링크) 혹은 기관명(기관명 적을시 어디 기관 권장 사항) 이런식으로"
        ...
        ITEMS.add(RecyclingSymbol(
            ...
            "1.오염된 종이 제외\n\n -음식물, 기름, 왁스 등으로 오염된 종이는 재활용에 적합하지 않습니다. 예를 들어, 기름진 피자 상자의 오염된 부분은 일반 쓰레기로 처리하고, 깨끗한 부분만 재활용해야 합니다.\n\n\n"+
                    "2.제거할 아이템 확인\n\n -테이프, 스테이플러, 플라스틱 클립 등은 가능한 한 제거하고 재활용하세요. 그렇지만 대부분의 재활용 시설은 이러한 소량의 금속이나 플라스틱을 분리할 수 있습니다.\n\n\n" +
        ...
        ITEMS.add(RecyclingSymbol(
            ...
            "1.비우기\n\n -종이팩에 남아있는 내용물을 완전히 비우십시오.\n\n\n"+
                    ...
                    "5.지정된 재활용통에 버리기\n\n -종이팩 재활용을 지원하는 지역에서는 지정된 재활용통이나 수거 지점에 종이팩을 버려야 합니다.",
            "-코팅된 종이류\n"+
                    "-이물질 혹은 음식물이 묻어있는 재활용품",
            "**참고 출처 수정** -> 링크(링크 적을 시 링크 제목 \n\n 링크) 혹은 기관명(기관명 적을시 어디 기관 권장 사항) 이런식으로"
        ))
